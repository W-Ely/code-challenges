...
def test_very_long_one():
    ...
    expected = [
        [
            'cet', 'cat', 'can', 'ian', 'inn', 'ins',
            'its', 'ito', 'ibo', 'ibm', 'ism'
        ], [
            'cet', 'get', 'gee', 'gte', 'ate', 'ats',
            'its', 'ito', 'ibo', 'ibm', 'ism'
            ], [
                'cet', 'cot', 'con', 'ion', 'inn',
                'ins', 'its', 'ito', 'ibo', 'ibm', 'ism'
            ]
    ]
    paths = find.findLadders(beginWord, endWord, wordList)
    for path in paths:
...
def test_four_chars_and_long():
    """Test long four char wordlist."""
    find = Solution()
    beginWord = "sand"
    endWord = "acne"
    ...
    expected = [['sand', 'sane', 'sade', 'side', 'aide', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sane', 'sine', 'side', 'aide', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'bans', 'bins', 'bids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'kans', 'kins', 'kids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'sins', 'kins', 'kids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'sins', 'bins', 'bids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'sins', 'sirs', 'airs', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'sins', 'sims', 'aims', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'sans', 'sins', 'sims', 'aims', 'arms', 'arts', 'ants', 'ante', 'anne', 'acne'], ['sand', 'band', 'bind', 'bins', 'bids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne'], ['sand', 'band', 'bans', 'bins', 'bids', 'aids', 'ands', 'ants', 'ante', 'anne', 'acne']]
    paths = find.findLadders(beginWord, endWord, wordList)
    for path in paths:
        assert path in expected
    for path in expected:
